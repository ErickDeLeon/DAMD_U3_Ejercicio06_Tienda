...
public class Lienzo6 extends View {
    ...
    Imagen6 fondogris, titulo, articulo01, articulo02,articulo03, articulo04, infoart01, infoart02, infoart03, infoart04, img01, img02, img03, img04, btnregresar, puntero;
    Main6Activity punActivity6;

    public Lienzo6 (Context context){
        super(context);

        fondogris = new Imagen6(R.drawable.fondogrisvert,100, 0,this);
        titulo = new Imagen6(R.drawable.titulogorras, 700, 10,this);

        articulo01 = new Imagen6(R.drawable.gorr01, 140, 30, this);
        articulo02 = new Imagen6(R.drawable.gorr02, 140, 800, this);
        articulo03 = new Imagen6(R.drawable.gorr03, 140, 1570, this);
        articulo04 = new Imagen6(R.drawable.gorr04,140,2340, this);


        img01 = new Imagen6(R.drawable.gorrimg01, 900, 450, this);
        infoart01 = new Imagen6(R.drawable.caminfo01, 650, 950,this);
        img01.hacerVisible(false);
        infoart01.hacerVisible(false);

        img02 = new Imagen6(R.drawable.gorrimg02, 900, 450, this);
        infoart02 = new Imagen6(R.drawable.caminfo02, 650, 950,this);
        img02.hacerVisible(false);
        infoart02.hacerVisible(false);

        img03 = new Imagen6(R.drawable.gorrimg03, 900, 450, this);
        infoart03 = new Imagen6(R.drawable.caminfo03, 650, 950,this);
        img03.hacerVisible(false);
        infoart03.hacerVisible(false);

        img04 = new Imagen6(R.drawable.gorrimg04, 900, 450, this);
        infoart04 = new Imagen6(R.drawable.caminfo02, 650, 950,this);
        img04.hacerVisible(false);
        infoart04.hacerVisible(false);

        btnregresar = new Imagen6(R.drawable.botonregresar, 1000,2100,this);

        punActivity6 = (Main6Activity) context;
    ...
    private void cambiarAHome() {
        ...
        Intent home = new Intent(punActivity6,MainActivity.class);
        punActivity6.startActivity(home);
