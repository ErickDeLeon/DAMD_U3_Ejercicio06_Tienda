...
public class Lienzo5 extends View {
    ...
    Imagen5 fondogris, titulo, articulo01, articulo02,articulo03, articulo04, infoart01, infoart02, infoart03, infoart04, img01, img02, img03, img04, btnregresar, puntero;
    Main5Activity punActivity5;

    public Lienzo5 (Context context){
        super(context);

        fondogris = new Imagen5(R.drawable.fondogrisvert,100, 0,this);
        titulo = new Imagen5(R.drawable.titulodisfraces, 700, 10,this);

        articulo01 = new Imagen5(R.drawable.dis01, 140, 30, this);
        articulo02 = new Imagen5(R.drawable.dis02, 140, 800, this);
        articulo03 = new Imagen5(R.drawable.dis03, 140, 1570, this);
        articulo04 = new Imagen5(R.drawable.dis04,140,2340, this);


        img01 = new Imagen5(R.drawable.disimg01, 900, 450, this);
        infoart01 = new Imagen5(R.drawable.caminfo01, 650, 950,this);
        img01.hacerVisible(false);
        infoart01.hacerVisible(false);

        img02 = new Imagen5(R.drawable.disimg02, 900, 450, this);
        infoart02 = new Imagen5(R.drawable.caminfo02, 650, 950,this);
        img02.hacerVisible(false);
        infoart02.hacerVisible(false);

        img03 = new Imagen5(R.drawable.disimg03, 900, 450, this);
        infoart03 = new Imagen5(R.drawable.caminfo03, 650, 950,this);
        img03.hacerVisible(false);
        infoart03.hacerVisible(false);

        img04 = new Imagen5(R.drawable.disimg04, 900, 450, this);
        infoart04 = new Imagen5(R.drawable.caminfo04, 650, 950,this);
        img04.hacerVisible(false);
        infoart04.hacerVisible(false);

        btnregresar = new Imagen5(R.drawable.botonregresar, 1000,2100,this);

        punActivity5 = (Main5Activity) context;
    ...
    private void cambiarAHome() {
        ...
        Intent home = new Intent(punActivity5,MainActivity.class);
        punActivity5.startActivity(home);
