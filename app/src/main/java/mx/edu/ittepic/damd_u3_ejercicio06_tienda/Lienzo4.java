...
public class Lienzo4 extends View {
    ...
    Imagen4 fondogris, titulo, articulo01, articulo02,articulo03, articulo04, infoart01, infoart02, infoart03, infoart04, img01, img02, img03, img04, btnregresar, puntero;
    Main4Activity punActivity4;

    public Lienzo4 (Context context){
        super(context);

        fondogris = new Imagen4(R.drawable.fondogrisvert,100, 0,this);
        titulo = new Imagen4(R.drawable.titulocamisa, 700, 10,this);

        articulo01 = new Imagen4(R.drawable.cam01, 140, 30, this);
        articulo02 = new Imagen4(R.drawable.cam02, 140, 800, this);
        articulo03 = new Imagen4(R.drawable.cam03, 140, 1570, this);
        articulo04 = new Imagen4(R.drawable.cam04,140,2340, this);


        img01 = new Imagen4(R.drawable.camimg01, 900, 450, this);
        infoart01 = new Imagen4(R.drawable.caminfo01, 650, 950,this);
        img01.hacerVisible(false);
        infoart01.hacerVisible(false);

        img02 = new Imagen4(R.drawable.camimg02, 900, 450, this);
        infoart02 = new Imagen4(R.drawable.caminfo02, 650, 950,this);
        img02.hacerVisible(false);
        infoart02.hacerVisible(false);

        img03 = new Imagen4(R.drawable.camimg03, 900, 450, this);
        infoart03 = new Imagen4(R.drawable.caminfo03, 650, 950,this);
        img03.hacerVisible(false);
        infoart03.hacerVisible(false);

        img04 = new Imagen4(R.drawable.camimg04, 900, 450, this);
        infoart04 = new Imagen4(R.drawable.caminfo04, 650, 950,this);
        img04.hacerVisible(false);
        infoart04.hacerVisible(false);

        btnregresar = new Imagen4(R.drawable.botonregresar, 1000,2100,this);

        punActivity4 = (Main4Activity) context;
    ...
    private void cambiarAHome() {
        ...
        Intent home = new Intent(punActivity4,MainActivity.class);
        punActivity4.startActivity(home);
