...
public class Lienzo2 extends View {
    ...
    Imagen2 fondogris, titulo, articulo01, articulo02,articulo03, articulo04, infoart01, infoart02, infoart03, infoart04, img01, img02, img03, img04, btnregresar, puntero;
    Main2Activity punActivity2;

    public Lienzo2 (Context context){
        super(context);

        fondogris = new Imagen2(R.drawable.fondogrisvert,100, 0,this);
        titulo = new Imagen2(R.drawable.tituloamiibos, 700, 10,this);

        articulo01 = new Imagen2(R.drawable.amb01, 140, 30, this);
        articulo02 = new Imagen2(R.drawable.amb02, 140, 800, this);
        articulo03 = new Imagen2(R.drawable.amb03, 140, 1570, this);
        articulo04 = new Imagen2(R.drawable.amb04,140,2340, this);


        img01 = new Imagen2(R.drawable.ambimg01, 900, 450, this);
        infoart01 = new Imagen2(R.drawable.ambinfo01, 650, 950,this);
        img01.hacerVisible(false);
        infoart01.hacerVisible(false);

        img02 = new Imagen2(R.drawable.ambimg02, 900, 450, this);
        infoart02 = new Imagen2(R.drawable.ambinfo02, 650, 950,this);
        img02.hacerVisible(false);
        infoart02.hacerVisible(false);

        img03 = new Imagen2(R.drawable.ambimg03, 900, 450, this);
        infoart03 = new Imagen2(R.drawable.ambinfo03, 650, 950,this);
        img03.hacerVisible(false);
        infoart03.hacerVisible(false);

        img04 = new Imagen2(R.drawable.ambimg04, 900, 450, this);
        infoart04 = new Imagen2(R.drawable.ambinfo04, 650, 950,this);
        img04.hacerVisible(false);
        infoart04.hacerVisible(false);

        btnregresar = new Imagen2(R.drawable.botonregresar, 1000,2100,this);

        punActivity2 = (Main2Activity) context;
    ...
    private void cambiarAHome() {
        ...
        Intent home = new Intent(punActivity2,MainActivity.class);
        punActivity2.startActivity(home);
